package com.yhw.nc.common.feign.converter;

import com.yhw.nc.common.feign.utils.ProtoUtil;
...
public class ProtostuffHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
    ...
    protected Object readInternal(Class<?> clazz, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ...
        try {
            return ProtoUtil.deserialize(inputMessage.getBody().readAllBytes(),clazz);
        } catch (Exception e) {
    ...
    protected void writeInternal(Object object, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
        ...
        FileCopyUtils.copy(ProtoUtil.serialize(object), outputMessage.getBody());
    }
