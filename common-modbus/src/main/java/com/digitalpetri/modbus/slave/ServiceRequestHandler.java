...
public interface ServiceRequestHandler {
    ...
    interface ServiceRequestRtu<Request extends ModbusRequest, Response extends ModbusResponse> extends ServiceRequest<Request,Response> {
        int getSiteId();
    }

    interface ServiceRequestTcp<Request extends ModbusRequest, Response extends ModbusResponse> extends ServiceRequest<Request,Response> {
        /**
